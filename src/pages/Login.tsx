...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-[var(--color-bg)]">
      <AuthSidePanel
        heading="Every idea starts with a single line."
        subheading="Draw it out with your team, live."
      />
      ...
      <div className="flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-semibold mb-1 fade-up">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="fade-up d3">
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-xs text-[var(--color-text-dim)]">Password</label>
